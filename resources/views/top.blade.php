...
<head>
    ...
    <meta name="description" content="LINEから簡単に予約できる美容室・理容室向けミニアプリRezamie（リザミー）">
...
<body class="bg-gray-50 text-gray-800 leading-relaxed font-sans">
    ...
    <div class="max-w-3xl mx-auto px-6 py-12">
        ...
        <h2 class="text-2xl font-semibold mb-2">主な機能</h2>
        <ul class="list-disc ml-6 mb-6">
            <li>LINEからの予約完結</li>
            <li>メニュー選択〜日時選択〜予約完了までの直感的な導線</li>
            <li>定休日・休憩時間に合わせた予約カレンダー</li>
            <li>予約完了後のLINE通知</li>
        </ul>

        <h2 class="text-2xl font-semibold mb-2">カスタマーサポート</h2>
        <p class="mb-4">
