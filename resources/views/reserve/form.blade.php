...
function updateMenuOptions() {
    ...
    const menuOptions = {
        ...
        cut_color: ['ノーマルカラー (白髪染め・ブラック・ブラウン系) 9600円~', 'グレイカラー (白髪ぼかし) 7100円~', 'ハイトーンカラー (青・金など要ブリーチ ※要相談) 14,700円~'],
        perm:  ['ノーマル 9500円〜', 'ピンパーマ 13500円〜', 'スパイラル 13500円〜'],
        color: ['ノーマルカラー (白髪染め・ブラック・ブラウン系) 5000円~', 'グレイカラー (白髪ぼかし) 2300円~', 'ハイトーン (青・金など要ブリーチ ※要相談) 11000円~'],
    };
